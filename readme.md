...
2024 - most users stopped using but we still have a few that need the payment plan, we're going to shut down the application soon, the last user is finishing their payments 🥳
